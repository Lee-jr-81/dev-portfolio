            ...
            <div className="space-y-8">
              ...
              <div className="space-y-8">
                ...
                <p className="text-body text-foreground/80">
                  ...
                  emphasis on clarity, performance, and maintainability. I care
                  less about trends and more about building systems that are
                  clean, scalable, and engineered to last.
                </p>
              </div>
              <a
                href="#contact"
